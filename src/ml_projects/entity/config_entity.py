...
# Generates a unique timestamp for every training run to avoid overwriting artifacts
...
class DataIngestionConfig:
    ...
    db_name: str = DB_NAME # Updated for MySQL context
...
@dataclass
class RailwayDemandPredictorConfig: # Renamed to reflect current project
